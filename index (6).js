...
const initializeBot = async () => {
    ...
    startApiServer();
    await autoLoadPairs();
    launchWhatsAppCommands();
};

function launchWhatsAppCommands() {
    console.clear();
    ...
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(chalk.yellow('⏸️ Telegram pairing bot: Disabled (website pairing only)'));
    ...
    if (whatsappLoaded) {
        ...
        console.log(chalk.red('⚠️  Warning: WhatsApp commands failed to load! Check your files.\n'));
    }
